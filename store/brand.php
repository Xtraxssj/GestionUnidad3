    ...
    <header>
        ...
        <nav class="navbar">
            <header class="nabvar-mobile is-size-5-mobile">
                ...
                <a class="navbar-mobile-link has-text-white" href="pagina_principal.php">Avenue Fashion</a>
            ...
            <nav class="nav-menu --nav-dark-light" id="mySidenav">
                ...
                <ul class="nav-menu-ul">
                    ...
                    <li class="nav-menu-item"><a href="brand.php" class="nav-menu-link active">La Marca</a></li>
